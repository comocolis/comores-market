...
import { Trash2, MapPin, Loader2, Plus, ArrowLeft, Eye } from 'lucide-react'
                ...
                return (
                    <div key={product.id} className="bg-white p-3 rounded-xl flex gap-3 shadow-sm border border-gray-100">
                        ...
                        <div className="flex flex-col justify-between items-end">
                            <Link href={`/annonce/${product.id}`} className="p-2 text-gray-400 hover:text-brand bg-gray-50 rounded-lg"><Eye size={18} /></Link>
